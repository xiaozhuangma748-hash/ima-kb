...
| **检索** | BM25 + 向量 + RRF 融合 + LLM 重排 | `ima search` / `/search` / `/api/search` |
| **问答** | RAG + 多轮对话 + 引用溯源 + 置信度阈值 | `ima ask` / 直接输入 / `/api/qa/stream`（SSE） |
...
TaskManager.get_active_tasks()  → 加载活跃任务
  │
  ▼
HybridRetriever.search(query)   → BM25 + 向量并行检索 + RRF 融合（k=60）
  │
  ▼
...
build_system_prompt(            → 按风格（scholar/warrior/artisan/neutral）
  style, pet, profile,            拼装 system prompt，注入宠物状态警告
  tasks, sources)
  │
  ▼
...
### 文件：[config.py](file:///Users/4u/Desktop/项目/拱墅区/2025身后事（殡葬）项目/34-知识库/config.py)
...
#### 文件：[run.py](file:///Users/4u/Desktop/项目/拱墅区/2025身后事（殡葬）项目/34-知识库/run.py)
...
#### 文件：[repl.py](file:///Users/4u/Desktop/项目/拱墅区/2025身后事（殡葬）项目/34-知识库/repl.py) → [core/cli/](file:///Users/4u/Desktop/项目/拱墅区/2025身后事（殡葬）项目/34-知识库/core/cli)

项目最核心的交互入口，实现 Claude Code 风格的终端常驻对话界面。原 `repl.py`（约 4300 行）已模块化拆分到 `core/cli/` 目录：

| 模块 | 职责 |
|---|---|
| [main.py](file:///Users/4u/Desktop/项目/拱墅区/2025身后事（殡葬）项目/34-知识库/core/cli/main.py) | REPL 启动入口（`main()` 函数） |
| [repl.py](file:///Users/4u/Desktop/项目/拱墅区/2025身后事（殡葬）项目/34-知识库/core/cli/repl.py) | REPL 主类（命令分发 + AI 对话） |
| [chat.py](file:///Users/4u/Desktop/项目/拱墅区/2025身后事（殡葬）项目/34-知识库/core/cli/chat.py) | AI 对话渲染（Markdown + 引用 + 宠物头像） |
| [completer.py](file:///Users/4u/Desktop/项目/拱墅区/2025身后事（殡葬）项目/34-知识库/core/cli/completer.py) | 命令自动补全（CommandCompleter） |
| [welcome.py](file:///Users/4u/Desktop/项目/拱墅区/2025身后事（殡葬）项目/34-知识库/core/cli/welcome.py) | 启动页渲染 + 活动记录 |
| [constants.py](file:///Users/4u/Desktop/项目/拱墅区/2025身后事（殡葬）项目/34-知识库/core/cli/constants.py) | 常量、命令列表、别名表、console 实例 |
| [commands/](file:///Users/4u/Desktop/项目/拱墅区/2025身后事（殡葬）项目/34-知识库/core/cli/commands) | 各命令处理器（Mixin 模式：agent/docs/graph/memory/pet/pipe/session/sync/analyze） |
...
##### 重要常量（定义在 [constants.py](file:///Users/4u/Desktop/项目/拱墅区/2025身后事（殡葬）项目/34-知识库/core/cli/constants.py)）
...
#### 文件：[web/app.py](file:///Users/4u/Desktop/项目/拱墅区/2025身后事（殡葬）项目/34-知识库/web/app.py)
...
#### 文件：[core/storage.py](file:///Users/4u/Desktop/项目/拱墅区/2025身后事（殡葬）项目/34-知识库/core/storage.py)
...
##### 文件：[core/ingestion/parser.py](file:///Users/4u/Desktop/项目/拱墅区/2025身后事（殡葬）项目/34-知识库/core/ingestion/parser.py)
...
##### 文件：[core/ingestion/chunker.py](file:///Users/4u/Desktop/项目/拱墅区/2025身后事（殡葬）项目/34-知识库/core/ingestion/chunker.py)
...
##### 文件：[core/ingestion/quick.py](file:///Users/4u/Desktop/项目/拱墅区/2025身后事（殡葬）项目/34-知识库/core/ingestion/quick.py)
...
- IDF 公式：`IDF(qi) = ln((N - n(qi) + 0.5)/(n(qi) + 0.5) + 1)`

##### 分词

```python
def tokenize(text: str) -> List[str]:
    """jieba 搜索引擎分词 + 停用词/单字符标点过滤"""
```

内置约 60 个中英文停用词表 `_STOP_WORDS`。

#### 6.3.2 向量索引

##### 文件：[core/retrieval/vector.py](file:///Users/4u/Desktop/项目/拱墅区/2025身后事（殡葬）项目/34-知识库/core/retrieval/vector.py)
...
##### 文件：[core/retrieval/hybrid.py](file:///Users/4u/Desktop/项目/拱墅区/2025身后事（殡葬）项目/34-知识库/core/retrieval/hybrid.py)
...
##### 文件：[core/retrieval/rerank.py](file:///Users/4u/Desktop/项目/拱墅区/2025身后事（殡葬）项目/34-知识库/core/retrieval/rerank.py)
...
##### 文件：[core/retrieval/citation.py](file:///Users/4u/Desktop/项目/拱墅区/2025身后事（殡葬）项目/34-知识库/core/retrieval/citation.py)
...
##### 文件：[core/llm/client.py](file:///Users/4u/Desktop/项目/拱墅区/2025身后事（殡葬）项目/34-知识库/core/llm/client.py)
...
##### 文件：[core/llm/degrade.py](file:///Users/4u/Desktop/项目/拱墅区/2025身后事（殡葬）项目/34-知识库/core/llm/degrade.py)
...
##### 文件：[core/qa/chain.py](file:///Users/4u/Desktop/项目/拱墅区/2025身后事（殡葬）项目/34-知识库/core/qa/chain.py)
...
##### 文件：[core/pet/administrator.py](file:///Users/4u/Desktop/项目/拱墅区/2025身后事（殡葬）项目/34-知识库/core/pet/administrator.py)
...
##### 文件：[core/memory/store.py](file:///Users/4u/Desktop/项目/拱墅区/2025身后事（殡葬）项目/34-知识库/core/memory/store.py)
...
##### 文件：[core/memory/profile.py](file:///Users/4u/Desktop/项目/拱墅区/2025身后事（殡葬）项目/34-知识库/core/memory/profile.py)
...
##### 文件：[core/memory/tasks.py](file:///Users/4u/Desktop/项目/拱墅区/2025身后事（殡葬）项目/34-知识库/core/memory/tasks.py)
...
##### 文件：[core/memory/workflow.py](file:///Users/4u/Desktop/项目/拱墅区/2025身后事（殡葬）项目/34-知识库/core/memory/workflow.py)
...
##### 文件：[core/persona/prompts.py](file:///Users/4u/Desktop/项目/拱墅区/2025身后事（殡葬）项目/34-知识库/core/persona/prompts.py)
...
##### 文件：[core/persona/styles.py](file:///Users/4u/Desktop/项目/拱墅区/2025身后事（殡葬）项目/34-知识库/core/persona/styles.py)
...
##### 文件：[core/pet/pet.py](file:///Users/4u/Desktop/项目/拱墅区/2025身后事（殡葬）项目/34-知识库/core/pet/pet.py)
...
##### 文件：[core/pet/interact.py](file:///Users/4u/Desktop/项目/拱墅区/2025身后事（殡葬）项目/34-知识库/core/pet/interact.py)
...
##### 文件：[core/pet/shop.py](file:///Users/4u/Desktop/项目/拱墅区/2025身后事（殡葬）项目/34-知识库/core/pet/shop.py)
...
##### 文件：[core/pet/tasks.py](file:///Users/4u/Desktop/项目/拱墅区/2025身后事（殡葬）项目/34-知识库/core/pet/tasks.py)
...
##### 文件：[core/pet/art.py](file:///Users/4u/Desktop/项目/拱墅区/2025身后事（殡葬）项目/34-知识库/core/pet/art.py)
...
##### 文件：[core/pet/storage.py](file:///Users/4u/Desktop/项目/拱墅区/2025身后事（殡葬）项目/34-知识库/core/pet/storage.py)
...
##### 文件：[core/graph/extractor.py](file:///Users/4u/Desktop/项目/拱墅区/2025身后事（殡葬）项目/34-知识库/core/graph/extractor.py)
...
##### 文件：[core/graph/store.py](file:///Users/4u/Desktop/项目/拱墅区/2025身后事（殡葬）项目/34-知识库/core/graph/store.py)
...
##### 文件：[core/graph/visualizer.py](file:///Users/4u/Desktop/项目/拱墅区/2025身后事（殡葬）项目/34-知识库/core/graph/visualizer.py)
...
##### 文件：[core/sync/tracker.py](file:///Users/4u/Desktop/项目/拱墅区/2025身后事（殡葬）项目/34-知识库/core/sync/tracker.py)
...
##### 文件：[core/sync/checker.py](file:///Users/4u/Desktop/项目/拱墅区/2025身后事（殡葬）项目/34-知识库/core/sync/checker.py)
...
##### 文件：[core/sync/dedup.py](file:///Users/4u/Desktop/项目/拱墅区/2025身后事（殡葬）项目/34-知识库/core/sync/dedup.py)
...
##### 文件：[core/analyze/analyzer.py](file:///Users/4u/Desktop/项目/拱墅区/2025身后事（殡葬）项目/34-知识库/core/analyze/analyzer.py)
...
##### 文件：[core/report/generator.py](file:///Users/4u/Desktop/项目/拱墅区/2025身后事（殡葬）项目/34-知识库/core/report/generator.py)
...
##### 文件：[core/reader/reader.py](file:///Users/4u/Desktop/项目/拱墅区/2025身后事（殡葬）项目/34-知识库/core/reader/reader.py)
...
##### 文件：[core/reader/comparator.py](file:///Users/4u/Desktop/项目/拱墅区/2025身后事（殡葬）项目/34-知识库/core/reader/comparator.py)
...
##### 文件：[core/agent/agent.py](file:///Users/4u/Desktop/项目/拱墅区/2025身后事（殡葬）项目/34-知识库/core/agent/agent.py) + [core/agent/tools/](file:///Users/4u/Desktop/项目/拱墅区/2025身后事（殡葬）项目/34-知识库/core/agent/tools)

LLM ReAct 模式工具调用。工具系统已模块化拆分到 `core/agent/tools/`：

- [base.py](file:///Users/4u/Desktop/项目/拱墅区/2025身后事（殡葬）项目/34-知识库/core/agent/tools/base.py) — `@register_tool` 装饰器 + `Tool` 基类（name/description/usage/run）
- [builtin.py](file:///Users/4u/Desktop/项目/拱墅区/2025身后事（殡葬）项目/34-知识库/core/agent/tools/builtin.py) — 内置工具集实现
...
##### 文件：[core/image/generator.py](file:///Users/4u/Desktop/项目/拱墅区/2025身后事（殡葬）项目/34-知识库/core/image/generator.py)
...
##### 文件：[core/session/store.py](file:///Users/4u/Desktop/项目/拱墅区/2025身后事（殡葬）项目/34-知识库/core/session/store.py)
...
##### 文件：[core/classify/tagger.py](file:///Users/4u/Desktop/项目/拱墅区/2025身后事（殡葬）项目/34-知识库/core/classify/tagger.py)
...
##### 文件：[core/ui/theme.py](file:///Users/4u/Desktop/项目/拱墅区/2025身后事（殡葬）项目/34-知识库/core/ui/theme.py)
...
| 路由模块 | 前缀 | 端点 | 说明 |
|---|---|---|---|
| [qa.py](file:///Users/4u/Desktop/项目/拱墅区/2025身后事（殡葬）项目/34-知识库/web/routes/qa.py) | `/api/qa` | `GET /stream` | SSE 流式问答 |
| [ingest.py](file:///Users/4u/Desktop/项目/拱墅区/2025身后事（殡葬）项目/34-知识库/web/routes/ingest.py) | `/api/ingest` | `POST /upload` `POST /url` | 文档入库 |
| [search.py](file:///Users/4u/Desktop/项目/拱墅区/2025身后事（殡葬）项目/34-知识库/web/routes/search.py) | `/api` | `GET /search` | 混合检索 |
| [analyze.py](file:///Users/4u/Desktop/项目/拱墅区/2025身后事（殡葬）项目/34-知识库/web/routes/analyze.py) | `/api/analyze` | `POST /` `GET /export` | 数据分析 |
| [stats.py](file:///Users/4u/Desktop/项目/拱墅区/2025身后事（殡葬）项目/34-知识库/web/routes/stats.py) | `/api` | `GET /stats` | 仪表盘统计 |
| [graph.py](file:///Users/4u/Desktop/项目/拱墅区/2025身后事（殡葬）项目/34-知识库/web/routes/graph.py) | `/api/graph` | `GET /data` `GET /neighbors/{name}` `POST /build` `GET /export` | 知识图谱 |
| [pet.py](file:///Users/4u/Desktop/项目/拱墅区/2025身后事（殡葬）项目/34-知识库/web/routes/pet.py) | `/api/pet` | `GET /status` `POST /interact` `POST /style` `POST /adopt` | 宠物管理 |
...
#### 文件：[web/templates/index.html](file:///Users/4u/Desktop/项目/拱墅区/2025身后事（殡葬）项目/34-知识库/web/templates/index.html)
...
#### 文件：[web/static/app.js](file:///Users/4u/Desktop/项目/拱墅区/2025身后事（殡葬）项目/34-知识库/web/static/app.js) + [web/static/js/](file:///Users/4u/Desktop/项目/拱墅区/2025身后事（殡葬）项目/34-知识库/web/static/js)

前端已从单文件 `app.js` 模块化拆分到 `web/static/js/` 目录，按页面/职责分离：

| 模块 | 职责 |
|---|---|
| [app.js](file:///Users/4u/Desktop/项目/拱墅区/2025身后事（殡葬）项目/34-知识库/web/static/app.js) | 入口：初始化 + 页面路由调度 |
| [nav.js](file:///Users/4u/Desktop/项目/拱墅区/2025身后事（殡葬）项目/34-知识库/web/static/js/nav.js) | 侧边栏导航 + 页面切换 |
| [qa.js](file:///Users/4u/Desktop/项目/拱墅区/2025身后事（殡葬）项目/34-知识库/web/static/js/qa.js) | AI 问答（SSE 流式 + Markdown 渲染 + 引用） |
| [ingest.js](file:///Users/4u/Desktop/项目/拱墅区/2025身后事（殡葬）项目/34-知识库/web/static/js/ingest.js) | 文档入库（拖拽上传 + URL 入库） |
| [search.js](file:///Users/4u/Desktop/项目/拱墅区/2025身后事（殡葬）项目/34-知识库/web/static/js/search.js) | 混合检索（标签筛选 + 高亮 + 相关度色条） |
| [analyze.js](file:///Users/4u/Desktop/项目/拱墅区/2025身后事（殡葬）项目/34-知识库/web/static/js/analyze.js) | 数据分析（Sheet 切换 + 统计 + AI 解读） |
| [dashboard.js](file:///Users/4u/Desktop/项目/拱墅区/2025身后事（殡葬）项目/34-知识库/web/static/js/dashboard.js) | 仪表盘（指标卡 + 标签分布 + 告警） |
| [graph.js](file:///Users/4u/Desktop/项目/拱墅区/2025身后事（殡葬）项目/34-知识库/web/static/js/graph.js) | 知识图谱（vis.Network 可视化 + 邻居查询） |
| [pet.js](file:///Users/4u/Desktop/项目/拱墅区/2025身后事（殡葬）项目/34-知识库/web/static/js/pet.js) | 宠物管理（ASCII 艺术 + 状态条 + 互动） |
| [state.js](file:///Users/4u/Desktop/项目/拱墅区/2025身后事（殡葬）项目/34-知识库/web/static/js/state.js) | 全局状态管理 |
| [utils.js](file:///Users/4u/Desktop/项目/拱墅区/2025身后事（殡葬）项目/34-知识库/web/static/js/utils.js) | 通用工具函数 |
...
| # | 决策 | 理由 |
|---|---|---|
| 1 | **BM25 + 向量混合检索** | BM25 关键词匹配 + 向量语义检索 + RRF 融合 + LLM 重排，四层流水线互补；向量库不可用时自动降级为纯 BM25 |
